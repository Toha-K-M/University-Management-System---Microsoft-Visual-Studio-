...
namespace University_Management_System
{
    public partial class teacher_management : Form
    {
        ...
        {
            disp_data();// TODO: This line of code loads data into the 'managementDataSet1.Teacher' table. You can move, or remove it, as needed.
            ...
            if (textBox1.Text != string.Empty)
            {
                if (textBox2.Text != string.Empty)
                {
                    try
                    {
                        ...
                        cmd.CommandText = "insert into [Teacher](Id,name,phone,email,address,age,gender) values (@id,@Name,@Phone,@Email,@Address,@Age,@Gender)";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update Teacher set name = @name, phone=@phone, email=@email, address=@address, age=@age, gender=@gender where Id=@id";
            cmd.Parameters.AddWithValue("@id", textBox1.Text);
            cmd.Parameters.AddWithValue("@name", textBox2.Text);
            cmd.Parameters.AddWithValue("@phone", textBox3.Text);
            cmd.Parameters.AddWithValue("@email", textBox4.Text);
